...
export default function Header() {
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const items: SearchItem[] = [
      ...
      { name: "Non-Dual Realization (Unified Awareness)", path: "/fruit/non-dual-realization", category: "Fruit" },
      ...
      { name: "Psychedelics & Mind", path: "/fruit/psychedelics", category: "Fruit" },
                ...
                {[
                  ...
                  },
                  {
                    ...
                    links: [
                      ...
                      { href: "/fruit/non-dual-realization",label: "Non-Dual Realization" },
                      { href: "/fruit/medicine",      label: "Medical Mindfulness" },
                      { href: "/fruit/meditation",    label: "Meditations" },
                      { href: "/fruit/psychedelics",  label: "Psychedelics & Mind" },
