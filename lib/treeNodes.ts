...
export const TREE_NODES: TreeNode[] = [
  ...
  { id: "rs_dvaita", name: "Dvaita (Duality)", question: "Individual soul and God are eternally separate.", path: "/roots/vedanta/dvaita", category: "roots", x: -3.2, y: -1.7, z: -0.4, x2d: 250, y2d: 715, color: "#ffd54f", size: 0.20, parentId: "r_vedanta" },
  { id: "rs_sankhya", name: "Samkhya Philosophy", question: "Discrimination between witness and matter.", path: "/roots/vedanta/sankhya", category: "roots", x: -2.4, y: -2.3, z: 0.8, x2d: 290, y2d: 730, color: "#ffca28", size: 0.20, parentId: "r_vedanta" },
  ...
  { id: "rs_sunyata", name: "Sunyata (Emptiness)", question: "All things are empty of independent essence.", path: "/roots/buddhism/sunyata", category: "roots", x: -0.2, y: -2.7, z: -1.4, x2d: 410, y2d: 785, color: "#ffb74d", size: 0.20, parentId: "r_buddhism" },
  { id: "rs_rigpa", name: "Rigpa (Pure Awareness)", question: "The spacious, self-luminous state.", path: "/roots/buddhism/rigpa", category: "roots", x: -0.7, y: -2.7, z: -0.5, x2d: 425, y2d: 765, color: "#ffa726", size: 0.20, parentId: "r_buddhism" },

  // Phenomenology Subroots
  { id: "rs_reduction", name: "The Reduction (Epoché)", question: "Bracket physical theories for raw experience.", path: "/roots/phenomenology/reduction", category: "roots", x: 1.2, y: -2.0, z: 0.2, x2d: 550, y2d: 735, color: "#ffab91", size: 0.20, parentId: "r_phenomenology" },
  { id: "rs_selfconstruct", name: "Self as Construct", question: "The transparent phenomenal self-model.", path: "/roots/phenomenology/self-construct", category: "roots", x: 1.7, y: -1.9, z: -0.4, x2d: 590, y2d: 750, color: "#ff8a65", size: 0.20, parentId: "r_phenomenology" },
  { id: "rs_presence", name: "Pure Presence", question: "The minimal pre-reflective subject.", path: "/roots/phenomenology/presence", category: "roots", x: 0.6, y: -2.3, z: 0.6, x2d: 630, y2d: 735, color: "#ff7043", size: 0.20, parentId: "r_phenomenology" },
  ...
  { id: "rs_astral", name: "Astral Travel & OBEs", question: "Awareness projecting outside spatial body.", path: "/roots/esoteric/astral-travel", category: "roots", x: 2.5, y: -2.4, z: 0.6, x2d: 745, y2d: 730, color: "#ffa726", size: 0.20, parentId: "r_esoteric" },
  { id: "rs_ndes", name: "NDEs & Flatlines", question: "Consciousness active during brain shutdown.", path: "/roots/esoteric/ndes", category: "roots", x: 2.6, y: -2.3, z: 1.1, x2d: 750, y2d: 715, color: "#ff9800", size: 0.20, parentId: "r_esoteric" },
  { id: "rs_enlightenment", name: "Enlightenment & Union", question: "Universal loss of subject-object boundary.", path: "/roots/esoteric/enlightenment", category: "roots", x: 1.5, y: -2.0, z: 1.0, x2d: 800, y2d: 700, color: "#fb8c00", size: 0.20, parentId: "r_esoteric" },

  // Direct Inquiry Subroots
  { id: "rs_selfinquiry", name: "Self-Inquiry Practice", question: "Inquire: 'To whom does this arise?'", path: "/roots/inquiry/self-inquiry", category: "roots", x: -0.2, y: -1.9, z: 1.3, x2d: 430, y2d: 705, color: "#ffe082", size: 0.22, parentId: "r_inquiry" },
  { id: "rs_netineti", name: "Neti Neti Negation", question: "Subtracting observer from observed.", path: "/roots/inquiry/neti-neti", category: "roots", x: 0.8, y: -1.8, z: 1.4, x2d: 480, y2d: 715, color: "#ffd54f", size: 0.22, parentId: "r_inquiry" },
  { id: "rs_witness", name: "The Witness", question: "The unchanging, silent screen of awareness.", path: "/roots/inquiry/witness", category: "roots", x: 0.2, y: -2.7, z: 1.0, x2d: 485, y2d: 765, color: "#ffca28", size: 0.22, parentId: "r_inquiry" },
  { id: "rs_whoami", name: "Who Am I?", question: "Reversing attention to its source.", path: "/roots/inquiry/who-am-i", category: "roots", x: -0.4, y: -2.4, z: 1.4, x2d: 495, y2d: 735, color: "#ffc107", size: 0.22, parentId: "r_inquiry" },
  ...
  { id: "f_moksha", name: "Moksha / Nirvana", question: "Absolute dissolution of subject-object boundary.", path: "/fruit/moksha-nirvana", category: "fruit", x: 0, y: 3.4, z: 0, x2d: 500, y2d: 80, color: "#ff9800", size: 0.30, parentId: "trunk" },
  ...
  { id: "f_reading", name: "Reading Paths", question: "Curated itineraries for science & seekers.", path: "/fruit/reading-paths", category: "fruit", x: -2.0, y: 2.8, z: -0.3, x2d: 180, y2d: 220, color: "#ffca28", size: 0.25, parentId: "b_neuroscience" },
  ...
  { id: "l_ramana", name: "Ramana Maharshi", question: "Sage of Atma Vichara.", path: "/leaves/ramana", category: "leaves", x: -0.6, y: -1.6, z: 0.8, x2d: 415, y2d: 685, color: "#fbc02d", size: 0.14, parentId: "r_inquiry" },
  { id: "l_nisargadatta", name: "Nisargadatta Maharaj", question: "Sage of 'I Am That'.", path: "/leaves/nisargadatta", category: "leaves", x: -0.2, y: -1.8, z: 0.7, x2d: 440, y2d: 760, color: "#fbc02d", size: 0.14, parentId: "r_inquiry" },
  ...
  { id: "l_patanjali", name: "Patanjali", question: "Systematizer of Chitta stillness.", path: "/leaves/patanjali", category: "leaves", x: 2.2, y: -1.4, z: 0.4, x2d: 745, y2d: 685, color: "#fbc02d", size: 0.14, parentId: "r_esoteric" },
  { id: "l_ramakrishna", name: "Ramakrishna Paramahamsa", question: "Phenomenologist of Unity.", path: "/leaves/ramakrishna", category: "leaves", x: 1.9, y: -1.7, z: 0.6, x2d: 780, y2d: 760, color: "#fbc02d", size: 0.14, parentId: "r_esoteric" },
  ...
  { id: "l_metzinger", name: "Thomas Metzinger", question: "Ego Tunnel theorist.", path: "/leaves/metzinger", category: "leaves", x: 1.4, y: -1.6, z: 0.3, x2d: 615, y2d: 705, color: "#81d4fa", size: 0.14, parentId: "r_phenomenology" },
  { id: "l_sarvapriyananda", name: "Sarvapriyananda", question: "Deep Sleep & Mandukya guide.", path: "/leaves/sarvapriyananda", category: "leaves", x: -1.4, y: -1.4, z: 0.4, x2d: 320, y2d: 765, color: "#fbc02d", size: 0.14, parentId: "r_vedanta" },
  { id: "l_spira", name: "Rupert Spira", question: "Direct Path guide.", path: "/leaves/spira", category: "leaves", x: 0.2, y: -1.4, z: 0.9, x2d: 458, y2d: 730, color: "#fbc02d", size: 0.14, parentId: "r_inquiry" },
  { id: "l_lucille", name: "Francis Lucille", question: "Socratic non-dual teacher.", path: "/leaves/lucille", category: "leaves", x: 0.5, y: -1.7, z: 0.7, x2d: 480, y2d: 700, color: "#fbc02d", size: 0.14, parentId: "r_inquiry" },
  ...
  { id: "l_jesus", name: "Jesus of Nazareth", question: "Kingdom of Heaven is within you.", path: "/leaves/jesus", category: "leaves", x: 2.3, y: -1.5, z: 0.7, x2d: 700, y2d: 725, color: "#a78bfa", size: 0.15, parentId: "r_esoteric" },
  { id: "l_papaji", name: "H.W.L. Poonja (Papaji)", question: "Direct disciple of Ramana Maharshi.", path: "/leaves/papaji", category: "leaves", x: -0.3, y: -1.7, z: 0.6, x2d: 410, y2d: 720, color: "#fbc02d", size: 0.14, parentId: "r_inquiry" },
  { id: "l_aurobindo", name: "Sri Aurobindo", question: "Integral Yoga — consciousness transforming matter.", path: "/leaves/aurobindo", category: "leaves", x: -4.8, y: -2.6, z: 0.5, x2d: 140, y2d: 830, color: "#10b981", size: 0.14, parentId: "r_vedanta" },
  { id: "l_williamjames", name: "William James", question: "Father of empirical mysticism.", path: "/leaves/williamjames", category: "leaves", x: 2.5, y: -1.3, z: 0.5, x2d: 815, y2d: 720, color: "#34d399", size: 0.14, parentId: "r_esoteric" },
  ...
  { id: "l_krishnamurti", name: "Jiddu Krishnamurti", question: "Truth is a pathless land.", path: "/leaves/krishnamurti", category: "leaves", x: -0.1, y: -1.4, z: 0.9, x2d: 445, y2d: 695, color: "#0284c7", size: 0.14, parentId: "r_inquiry" },
  { id: "l_watts", name: "Alan Watts", question: "Ego is a skin-encapsulated illusion.", path: "/leaves/watts", category: "leaves", x: 0.6, y: -1.3, z: 0.8, x2d: 465, y2d: 735, color: "#0284c7", size: 0.14, parentId: "r_inquiry" },
